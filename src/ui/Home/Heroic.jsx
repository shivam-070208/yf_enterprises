...
//         className="w-full pb-10 h-[80vh] md:h-[114vh] cursor-grab"
//       >
//         {slides.map((slide, i) => (
//           <SwiperSlide key={i}>
//             <div
...
//               <div className="absolute top-4 left-4 bg-white text-black px-4 py-1 text-sm font-semibold rounded opacity-0 group-hover:opacity-100 transition-all duration-300 z-10">
