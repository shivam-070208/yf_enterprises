...
//             Expert Electrical & Instrumentation Services for Every Industry Need
//           </h2>
    ...
    <section className="relative py-24 mb-12 px-4  md:px-16 mt-10 bg-[#f5f5f570] backdrop-blur-md">
      ...
      <div className="relative z-10 max-w-7xl mx-auto mt-8">
        ...
        >
          {services.map((service, index) => (
            <SwiperSlide key={index}>
              <div className="group relative mx-auto w-fit h-fit cursor-pointer rounded-xl overflow-hidden transition-all duration-300">
                ...
                {/* This div will hold the icon and title/subtitle, appearing from the bottom on hover */}
                <div className="absolute bottom-0 w-full flex justify-between transform translate-y-full group-hover:translate-y-0 transition-transform duration-700">
                   <div className='px-4 py-3 text-white grid place-items-center text-5xl bg-orange-500'><FaIndustry /></div>
                    <div className='w-fit px-6 max-w-70 py-4 h-full bg-white'>
                        <h5 className="text-xl font-bold line-clamp-2">{service.title}</h5>
                        {/* The description will be visible when the div slides up */}
